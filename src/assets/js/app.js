...
function block(text){ const div=document.createElement('div'); div.className='main-card'; div.innerHTML=`<h2 style="margin:0 0 .5rem 0;">RockySEN</h2><p>${text}</p>`; root.replaceChildren(div); return null; }
